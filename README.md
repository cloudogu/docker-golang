...
Docker image for building Golang projects. The image is based on the official golang docker images and adds some useful tools.
The main goal of the docker image is the usage on a ci server such as jenkins.
